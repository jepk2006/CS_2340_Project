...
urlpatterns = [
    ...
    path("profile/<int:pk>/", views.profile_detail, name="profile_detail_pk"), # For viewing other profiles
    path("profile/edit/", views.profile_update, name="profile_edit"), # Renamed view
